...
image: "/images/chd8tag_mouse.png"
imageAlt: "Experimental outline of the in-vivo inducible biotinylation system we are using to map Chd8 regulatory networks at cellular resolution."
imageCaption: "Experimental outline of the *in-vivo* inducible biotinylation system we are using to map *Chd8* regulatory networks at cellular resolution."
order: 2
---
